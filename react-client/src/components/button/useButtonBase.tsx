...
function useButtonBase({
  ...
  const className = classNames("rounded-full min-w-[175px] h-[48px] py-3.5 px-large outline outline-transparent focus:outline-orange-300-contrast outline-2 outline-offset-2", {
