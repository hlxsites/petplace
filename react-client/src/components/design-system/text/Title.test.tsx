...
const DEFAULT_CLASSES = "font-bold text-neutral-950"
...
describe("<Title />", () => {
  ...
  it("should render default classes", () => {
    getRenderer();
    expect(getByRole("heading")).toHaveClass(DEFAULT_CLASSES);
  });
  ...
  it.each([
    ...
    expect(getByRole("heading")).toHaveClass(`${DEFAULT_CLASSES} ${classes}`);
  });
});
