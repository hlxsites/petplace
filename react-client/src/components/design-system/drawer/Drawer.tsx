  ...
  return (
    <DialogBase
      ...
      className={{
        ...
        modal:
          "fixed bottom-0 left-0 right-0 z-50 max-h-90vh w-full rounded-t-2xl bg-neutral-white duration-300 ease-in-out lg:left-auto lg:top-0 lg:max-h-screen lg:rounded-none",
      }}
      element="drawer"
