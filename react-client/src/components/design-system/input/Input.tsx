    ...
    <div className="flex flex-col">
      ...
      <div
        className={classNames(
          ...
          {
            "rounded-lg": squared,
            "border-brand-main border-2": isFocused,
      ...
      >
        ...
        <input
          id={id}
          className={classNames(
            "min-w-300 placeholder:text-text-hinted disabled:bg-background-disabled disabled:text-text-disabled ml-small h-12 rounded-full bg-neutral-white py-[0px] outline-none",
            {
