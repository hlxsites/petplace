...
async function getData(url, offset, interval){
    fetch(`https://helix-pages.anywhere.run/helix-services/run-query@ci6232/rum-dashboard?domainkey=e91cd625-8efc-44ce-bae4-7c8d1e8d3019&interval=${interval}&offset=${offset}&limit=4&url=${url}&exactmatch=true`)
    .then((res) => res.json())
    .then((resp) => {
